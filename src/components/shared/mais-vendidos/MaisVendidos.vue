...
import ListaProdutos from '../lista-produtos/ListaProdutos.vue'
...
export default {
  ...
  data () {
    return {
      listaInline: true, // TODO: Deve vir da API
  ...
  mounted () {
    if (this.listaInline) {
      this.swiperMaisVendidos = new Swiper('.mais-vendidos .row-produtos', {
        slidesPerView: 3,
